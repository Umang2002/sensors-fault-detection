...
class DataIngestion:
    ...
    def export_data_into_featutre_store(self) -> DataFrame:
        """
        Export mongodb collection record as data frame into feature
        """
        try:
            logging.info("Exporting data from mongodb to featureStore")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
         try:
             dataframe = self.export_data_into_featutre_store()
